                                        ...
                                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bolder text-end"># {{number_format($order->total_price,2)}}</td>
                                                </tr>
                                                <!--end::Date-->
                                            </tbody>
                                            <!--end::Table body-->
                                        ...
                                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bolder text-end">
                                                        <a href="#" class="text-gray-600 text-hover-primary">{{$order->location}}<br>{{$order->address}}</a>
                                                    </td>
                                                </tr>
                                                <!--end::Payment method-->
                                                <!--begin::Date-->
                                                ...
                                                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                    ...
                                                    <tbody class="fw-bold text-gray-600">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <!--begin::Title-->
                                                                    <div class="ms-5">
                                                                        <a href="../catalog/edit-product.html" class="fw-bolder text-gray-600 text-hover-primary">{{$product['name']}}</a>
                                                            ...
                                                            <!--end::Price-->
                                                            <!--begin::Total-->
                                                            <td class="text-end">₦{{number_format($product['price'] * $product['qty'],2) }}</td>
                                                            <!--end::Total-->
                                                        </tr>
                                                        @endforeach
                                                        <br>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end">₦{{number_format($order->delivery_amount,2)}}</td>
                                                        </tr>
                                                        <!--end::VAT-->
                                                        <!--begin::Shipping-->
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="text-end"></td>
                                                            <td colspan="text-end" class="text-end"></td>
                                                            <td colspan="text-end" class="fs-3 text-dark text-end">Grand Total</td>
                                                            <td class="text-dark fs-3 fw-boldest text-end">₦{{number_format($order->total_price + $order->delivery_amount + 50,2)}}</td>
                                                        </tr>
                                                        <!--end::Grand total-->
                                                    </tbody>
                                                    <!--end::Table head-->
