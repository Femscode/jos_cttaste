			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-xxl" id="kt_content_container">
						...
						<div class='row'>
						<div class='col-md-4'>
							<form method='post' action='{{ route("update_discount_unit") }}'>@csrf
								<div class='card'>
									<div class='card-header'>
										<h4>Set Discount Quantity</h4>
									</div>
									<div class='card-body'>
								<input required type='number' name='discount' class='form-control' value='{{ $discount->promo ?? "" }}' placeholder='Discount unit'><br>
								<input type='text' name='sponsor' value='{{ $discount->sponsor ?? "" }}' class='form-control' placeholder='Sponsor(Optional)'><br>
								<input type='submit' class='btn btn-primary btn-sm justify-content-center' value='Submit'/>
									</div>
								</div>
							</form>
						</div>
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
									...
									<thead>
										...
										<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
											...
											<th class="text-end min-w-70px">Restaurant</th>
											<th class="text-end min-w-100px">Location</th>
											<th class="text-end min-w-100px">Sponsor</th>
									...
									<tbody class="fw-bold text-gray-600">
										...
										<tr>
											...
											<td class="text-end pe-0" data-order="Completed">
												...
												<div class="badge badge-light-success">{{ $user->restaurant->name }}</div>
											...
											<td class="text-end pe-0">
												<span class="fw-bolder">{{ $user->location }}</span>
											</td>
											<!--end::Total=-->
											<!--begin::Date Added=-->
											<td class="text-end" data-order="2022-01-28">
												
												<span class="badge badge-secondary">{{$user->sponsor ?? 'CT-Taste'}}</span>
											...
											<td class="text-end" data-order="2022-01-31">
												<span class="fw-bolder">{{Date("d-m-Y",strtotime($user->created_at))}}</span>
											</td>
											<!--end::Date Modified=-->
											<!--begin::Action=-->
											<td class="text-end">
