                ...
                <div class="modal-body scroll-y mx-5 mx-xl-5 my-15">
                    ...
                    <form method='post' id='updatefood' enctype="multipart/form-data" class="form fv-plugins-bootstrap5 fv-plugins-framework">@csrf
                        ...
                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                            ...
                            <input required type="number" id='edit_menu_price' class="form-control form-control-solid" placeholder="Input Price" name="price" value="">
                        </div>
                        ...
                        <div id='edit_selectimage' class='fv-plugins-icon-container'>
                            ...
                            <!--end::Label-->
                            <input type="file" id='edit_menu_image' class="form-control form-control-solid" name='name' value="">
                           
                        </div>
                        <div>
                            <br><p id='edit_showimage2'>Click <a id='edit_showimage' style='color:blue;cursor:pointer'>here</a> to select from our list of food images</p>
                        ...
                        <div id='edit_imageContainer' class='fv-plugins-icon-container' style='display:none'>
                            <!--begin::Label-->
                            <br><p>Click <a id='edit_hideimage' style='color:blue;cursor:pointer'>here</a> to upload your own picture</p>
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                            ...
                            <!--end::Label-->
                            <input id='edit_food_search' type="text" placeholder="Rice" id='edit_image' class="form-control form-control-solid" value="">
                            <br>
                            <div class="row" id='edit_listimages'>
                                @foreach($foodimages as $pp)
                                <img src='https://cttaste.com/cttaste_files/public/foodimages/{{ $pp->image }}' data-name='{{ $pp->category }}' data-image='{{ $pp->image }}' class="edit_selectedimage img-thumbnail rounded m-5" style='width:100px;height:100px'>
                                @endforeach
                            </div>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-5 my-15">
                    ...
                    <form id='createfood' enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <input required type="number" id='price' class="form-control form-control-solid" placeholder="Input Price" name="price" value="">
                        ...
                        <div>
                            <br><p id='showimage2'>Click <a id='showimage' style='color:blue;cursor:pointer'>here</a> to select from our list of food images</p>
                        ...
                        <div id='imageContainer' class='fv-plugins-icon-container' style='display:none'>
                            <!--begin::Label-->
                            <br><p>Click <a id='hideimage' style='color:blue;cursor:pointer'>here</a> to upload your own picture</p>
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                <span class="required">Search for food</span></span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="Specify a card holder's name" aria-label="Specify a card holder's name"></i>
                            </label>
                            ...
                            <!--end::Label-->
                            <input id='food_search' type="text" placeholder="Rice" id='image' class="form-control form-control-solid" value="">
                            <br>
                            <div class="row" id='listimages'>
                                @foreach($foodimages as $pp)
                                <img src='https://cttaste.com/cttaste_files/public/foodimages/{{ $pp->image }}' data-name='{{ $pp->category }}' data-image='{{ $pp->image }}' class="selectedimage img-thumbnail rounded m-5" style='width:100px;height:100px'>
                                @endforeach
                            </div>
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <input type='text' id='searchFood' class='form-control' placeholder="Search Category"/>
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                ...
                                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="" data-bs-original-title="Click to add menu">
                                    <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_menu">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                                        <div class="symbol-label" id='image-{{ $food->id }}' style="background-image: url('https://cttaste.com/cttaste_files/public/foodimages/{{ $food->image }}')"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#" id='name-{{ $food->id }}' class="text-dark fw-bolder text-hover-primary fs-6">{{$food->name}}</a>
                                                            {{-- <span class="text-muted fw-bold text-muted d-block fs-7">{{$food->quantity}}</span> --}}
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="">
                                                    <div class="d-flex flex-column w-100 me-2">
                                                        <a href="#" id='price-{{ $food->id }}' class="text-dark fw-bolder text-hover-primary d-block fs-6">#{{$food->price}}</a>
                                               ...
                                               <td>
                                                   <div class="d-flex align-items-center">
                                                       ...
                                                       <div class="d-flex justify-content-start flex-column">
                                                           ...
                                                           <span class="text-muted fw-bold text-muted d-block fs-7">${value.quantity}</span>
                                                       </div>
                                                   </div>
                                               </td>
