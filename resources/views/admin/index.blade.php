	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-8"
				id="kt_aside_logo">
				<a href="index.html">
					<img alt="Logo" src="{{asset('assets/images/logo.png')}}" class="h-55px" />
				</a>
			</div>
			<!--end::Logo-->
			<!--begin::Nav-->
							...
							<div class="d-flex align-items-stretch justify-self-end flex-shrink-0">
								...
								<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true" style="">
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a onclick='return confirm("Are you sure you want to logout")' href="logout" class="menu-link px-5">Sign Out</a>
										</div>
										<!--end::Menu item-->
									</div>
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
									...
									<thead>
										...
										<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
											...
											<th class="text-end min-w-100px">Date Started</th>
									...
									<tbody class="fw-bold text-gray-600">
										...
										<tr>
											...
											<td class="text-end pe-0">
												<span class="fw-bolder"># {{number_format(100000)}}</span>
											</td>
											<!--end::Total=-->
											<!--begin::Date Added=-->
											...
											<div class="card-toolbar">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true" style="">
														...
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="userprofile/{{$user->id}}" class="menu-link px-3">View Profile</a>
														</div>

														<div class="menu-item px-3 my-1">
															<a href="userorder/{{$user->id}}" class="menu-link px-3">View Order</a>
														</div>

														<div class="menu-item px-3 my-1">
															<a href="userfood/{{$user->id}}" class="menu-link px-3">View Food</a>
														</div>
