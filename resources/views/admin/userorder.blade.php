...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo4/apps/ecommerce/sales/listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 02:22:51 GMT -->
<!-- Added by HTTrack -->
							...
							<div class="d-flex align-items-stretch justify-self-end flex-shrink-0">
								...
								<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true" style="">
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="http://127.0.0.1:8000/logout" class="menu-link px-5">Sign Out</a>
										</div>
										<!--end::Menu item-->
									</div>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div class="ms-5">
														<!--begin::Title-->
														<a href="../../user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">{{$order->name}}</a>
														<!--end::Title-->
													</div>
												</div>
											</td>
