            ...
            <div style='padding-left:0px !important' class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div style='padding-top:10px' class="container-xxl" id="kt_content_container">
                        ...
                        <form method='post' action='{{route("checkout", [$cc*$rest->pack_fee+$rest->ct_charge])}}' class="form d-flex flex-column flex-lg-row">
                            @csrf
                            <!--begin::Aside column-->
                            ...
                            <div class="d-flex flex-column flex-lg-row-fluid p-8">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="alert alert-danger">
                                        ...
                                        <ul>
                                           Kindly select your delivery location properly!
                                        </ul>
                                    </div>
                                    @endif
                                    </div>
                                        ...
                                        <div class="d-flex flex-column gap-10">
                                            ...
                                            <div class="d-flex align-items-center position-relative mb-n7">
                                                ...
                                                <h4 class='float-right' id='total_price'>Total Price: #
                                                    {{number_format($carts->totalPrice)}}</h4>
                                            </div>
                                ...
                                <!--end::Order details-->
                                @if($rest->block == 0)
                                <div class='text-danger justify-content-end m-4'>Fund your <a href='https://fastpay.cttaste.com/register' style='color:blueviolet'> fastpay wallet </a> today, and save yourself the stress of bank transfer everytime!</div>
                                @endif
