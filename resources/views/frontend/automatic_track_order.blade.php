                        ...
                        <div class="breadcrumb-content">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">NGN{{ number_format($order->total_price,2) }}</li>
                                    <li class="dots2"></li>
                                </ol>
                            </nav>
                    ...
                    <div class="col-xl-8 col-lg-10">
                        <div class="tracking-id-info text-center">
                            ...
                            <div class="tracking-list">
                                ...
                                @elseif($delivery->rejected == 1)
                                <div class='alert alert-danger'>This order has been rejected by the vendor!</div>
                                @else 
                                <ul>
                                    <li>
                                        <div class="tracking-list-icon">
                                    ...
                                    <li  @if( time() > strtotime($delivery->request_time) && time() < strtotime($delivery->pick_up_time) && time() <
                                        strtotime($delivery->delivery_time)) class="active" @endif>
                                        <div class="tracking-list-icon">
                                            <i class="flaticon-warehouse"></i>
                                        </div>
                                        <div class="tracking-list-content">
                                    ...
                                    <li @if(  time() > strtotime($delivery->pick_up_time) && time() < strtotime($delivery->delivery_time)) class="active" @endif> 
                                        <div class="tracking-list-icon">
                                            <i class="flaticon-placeholder"></i>
                                        </div>
                                        <div class="tracking-list-content">
                                    ...
                                    <li @if(time() > strtotime($delivery->delivery_time)) class="active" @endif>
                                        <div class="tracking-list-icon">
                                            <i class="flaticon-audit"></i>
                                        </div>
                                        <div class="tracking-list-content">
                            ...
                            data-target="#reportVendor" class="btn red-btn m-2">Make Review</button>
																			...
																			<div class="modal-content">
																				...
																				<div class="modal-footer">
																					...
																					<button id='report_vendor_submit'
																						type="button" style='background:#ebab21'
                            ...
                            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end text-dark">@if($delivery && time() > strtotime($delivery->pick_up_time)) {{ $delivery->rider_name }} @else Not yet assigned @endif
                                        </td>
                                    </tr>
                                    <!--end::Payment method-->
                                    <!--begin::Date-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end text-dark"><a
                                                href='tel:{{ $delivery->rider_phone ?? "" }}'>@if($delivery && time() > strtotime($delivery->pick_up_time)) {{ $delivery->rider_phone }} @else Not yet assigned @endif</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-dark">
                                        ...
                                        <td class="fw-bolder text-end text-dark">@if($delivery) {{ date('h:i A', strtotime($delivery->request_time)) }} @else 0:00 @endif 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-dark">
                                        ...
                                        <td class="fw-bolder text-end text-dark">@if($delivery && time() > strtotime($delivery->pick_up_time)) {{ Date('h:i A',strtotime($delivery->pick_up_time)) }} @else Not yet picked up @endif
                                        </td>
                                    </tr>
                                    <!--end::Date-->
                                </tbody>
