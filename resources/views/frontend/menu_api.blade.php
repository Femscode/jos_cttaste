...
<head>
	...
	<meta property="og:site_name" content="No 1 Food Ordering Platform For Students" />
...
<body id="kt_body" style='background-color:#f8f9fa !important' class="header-tablet-and-mobile-fixed">
	...
	<div id='post_body' style='display:none'>
		<div class="d-flex flex-column flex-root">
			<!--begin::Page-->
			<div class="page d-flex flex-row flex-column-fluid">
				<!--begin::Aside-->
				<div id="kt_aside" class="aside bg-primary" style='background:#ebab21 !important;color:#640f11;' data-kt-drawer="true"
					...
					<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-8"
						id="kt_aside_logo">
						<a href="/">
							<img alt="Logo" src="{{asset('assets/images/logo-br.png')}}" class="h-25px" />
						</a>
					</div>
					<!--end::Logo-->
					<!--begin::Nav-->
				...
				<!--end::Aside-->
				<!--begin::Wrapper-->
				<div class="wrapper d-flex flex-column flex-row-fluid" style='padding-left:0px !important'
					id="kt_wrapper">
					<!--begin::Header-->

					<!--end::Header-->
					<!--begin::Content-->
					<div class="content d-flex flex-column flex-column-fluid" style='background:#eee5e5'
						id="kt_content">
						<!--begin::Container-->
						<div style='' class="container-xxl" id="kt_content_container">
							<!--begin::Form-->
										...
										<div class="card-body p-0">
											...
											<div class="mixed-widget card-rounded-bottom" data-kt-color="danger"
														...
														<div class="carousel-inner">
															<div class="carousel-item active">
																<img class="mixed-widget card-rounded-bottom"
																	src="assets/images/banner3.jpeg" alt="Third slide"
																	class="card-img-top"
															...
															<div class="carousel-item">
																...
																{{-- <div class="mixed-widget card-rounded-bottom"
																	src="assets/images/banner3.jpeg" alt="Second slide"
																	style="background:url({{ asset("
																	profilePic/".$rest->image)
																	}});background-size:cover;height: 250px; min-height:
																	200px;opacity:1">
																</div> --}}
															...
															<div class="carousel-item">
																<img class="mixed-widget card-rounded-bottom"
																	src="assets/images/slider_02.jpg" alt="Third slide"
																	class="card-img-top"
																	style='width: 100%;height: 250px;object-fit: cover;'>
												...
												{{-- <div class="mixed-widget card-rounded-bottom"
													...
													style="background:url('assets/images/banner3.jpeg');background-size:cover;height: 250px; min-height: 200px;opacity:1">
													--}}
													@endif
												...
												<div class="card-p mt-n20 position-relative">
													...
													<div class="row g-0">
														...
														<!--begin::Col-->
														<div style='background:#FDFEFF !important'
															class="col-md-12 bg-white px-6 py-8 rounded-2 me-7 shadow-lg">
															<marquee direction='left'
																class='animate__animated animate__bounce rounded m-0 p-2'
																style='background:black;color:white' width='100%'
																;height='100px'>
																{{-- <a
																	href='https://wa.me/2349058744473?text=*Hi,%20%20I%20will%20like%20to%20sponsor%20CTTASTE%20free%20delivery.*'
																	class='checkoutdesign2'
																	style="color:white;font-family: 'Ubuntu', sans-serif;">
																	--}}
																	<a href='https://caretech.netlify.app'
																		class='checkoutdesign2'
																		style="color:white;font-family: 'Ubuntu', sans-serif;">
																		Wants to build any type of website or
																		web-applications with as low as NGN79,999?
																		(Click here to know more about CareTech
																		Services).
																	</a>
															</marquee>
															...
															<div class="columns">
																...
																<div class="vendor-header-info mbm ">
																	<a class='btn btn-primary btn-sm' href='/'>←Home</a>
																	<a class='btn btn-danger btn-sm' data-toggle="modal"
																		data-target="#reportVendor">Make Review</a>

																	<!-- Modal -->
																	<div class="modal fade" id="reportVendor"
																			...
																			<div class="modal-content">
																				<div class="modal-header">
																					<h5 class="modal-title"
																						...
																						Make a review for {{ $rest->name
																						}}?</h5>
																					<button type="button"
																						style='border:none;font-size:20px;color:red'
																						class="close"
																						data-dismiss="modal"
																						aria-label="Close">
																						<span
																				...
																				<div class="modal-body">
																					<form class='reportmyvendor'>
																						<h6 style="font-family: 'Ubuntu', sans-serif;">
																							Mobile No:</h6>
																						<input type='number' id='phone_no' placeholder='08XXXXXXXXX' class='form-control'/>
																						<h6 style="font-family: 'Ubuntu', sans-serif;">
																							Review/Complaint:</h6>
																						<input type='hidden'
																							id='restaurant_name'
																				...
																				<div class="modal-footer">
																					...
																					<button id='report_vendor_submit'
																						type="button"
			...
			<h1 style="text-align:center;font-family: 'Ubuntu', sans-serif;" class="vendor-header-title">
				{{$rest->name}} - {{$rest->address}} <span>
					| 5.0 <span style='color:gold'>★★★★★
					</span> <span class="bull-bfr"><br>
			</h1>

			<br>
			@if($rest->approve == 0 )
			<p style="font-family: 'Ubuntu', sans-serif;color:black" class='text-center alert alert-danger'>Please
				note that
				this page
				will not
				be
				accessible to your customers until your account
				is
				approved!
			</p>
			@endif
			<h4 style="font-family: 'Ubuntu', sans-serif;" class='text-danger text-center'>
				{{ $rest->description }}
			...
			<div id='cat_cat' style='padding:0px !important;' class="container testimonial-group">
				<div class="rowlex text-center">
					@foreach($cats as $cat)
					<a href="#pepe{{$cat->id}}" style='font-size:15px'
						class="collex-xm-4 btn btn-sm btn-light btn-color-muted btn-active-light-danger py-2 mb-2">
						{{$cat->name}}
					</a>
					@endforeach
				</div>
	...
	<div class="card">
		@if($rest->image !== null)
		<img src='{{ asset("profilePic/".$rest->image) }}' style='width: 100%;height: 150px;object-fit: cover;'
			class="card-img-top">
		@else
		<img src='{{ asset(' profilePic/normal.jpg') }}' class="card-img-top"
	...
	<!--end::Card header-->
	<!--begin::Card body-->
	<div class="card-body p-8" style='background:#fff;'>
		<div class="d-flex flex-column gap-10">
			...
			<!--begin::Table-->
			<div class='row'>
				<div class="card pt-4 col-xl-8 shadow-lg" style='border:1px dashed black'>
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5"
						...
						<thead>
							<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
								...
								<th class="min-w-100px text-end pe-5">
									<a href='/showcart'>
										<div style='position:fixed;font-size:30px'>
										</div>
									</a>
								</th>
							</tr>
						...
						<tbody class="fw-bold text-gray-600">
							...
							<div style='padding:0px 2px 0px 105x !important'
								class="d-flex align-items-center bg-light-white rounded p-5 mb-1">
								<span class="svg-icon svg-icon-danger me-5">

									<div id='pepe{{$menu->category_id}}' class="symbol symbol-60px symbol-2by3 me-4">
								...
								<div class="flex-grow-1 me-2">
									<a href="#" style='color:#640f11;font-size:15px !important'
										class="fw-bolder text-hover-primary fs-6">{{$menu->name}}</a>

									<span class="text-black fw-bolder d-block" style='color:grey !important'>Price: NGN
										{{number_format($menu->price)}}</span>
									<!--	@if($menu->quantity >= 1)-->
									<!--<span class="text-#640f11 fw-bold d-block"-->
									<!--	style='color:#640f11'>Quantity Left:-->
									<!--	{{$menu->quantity}}</span>-->
									<!--	@endif-->
								...
								<div class="btn-group mb-md-0 btn-block">
									<button data-id='{{$menu->id}}' disabled id='deletefood{{ $menu->id }}'
										type="button"
										style='background:red;color:black;font-size:20px;padding:2px 10px;display:none'
										class="deletefood btn btn-danger btn-sm">-</button>
									<button data-id='{{$menu->id}}' type="button"
										style='color:black;font-size:20px;padding:2px 10px;border-top-right-radius:7px'
										class="addmenu btn btn-warning btn-sm">+</button>
									<sup class='cfood' id='currentfood{{$menu->id}}' style='font-size:15px'></sup>
								</div>
				...
				<div id='subcart' class="col-xl-4 mb-8">
					<!--begin::List Widget 3-->
					<div class="card card-xl-stretch mb-xl-8 bg-light-success"
						style='border-right:5px double #fff;border-bottom:5px solid #fff;border-left:5px double #ebab21;border-top:5px double #ebab21;background:#fff !important'>
						<!--begin::Header-->
						<div class="card-header border-0">
							<h6 class="card-title fw-bolder text-dark">MY ORDERS

							</h6>
							<div class="card-toolbar">
								<!--begin::Menu-->
								<a id='addplate' class='btn btn-sm btn btn-secondary btn-active-light-primary p-2'>Add
									New
									Pack</a>

								<a id='duplicatepack' style='margin-left:3px'
									class='btn btn-sm btn btn-dark btn-active-light-success ml-2 p-2'>Duplicate
									Pack</a>
						...
						<div id='plate'>
							...
							<div class="platerow card-body pt-2">
								...
								<div class="d-flex align-items-center mb-8">
									<!--begin::Bullet-->
									<span id='active1' class="allactive bullet bullet-vertical h-40px bg-danger"
										style='margin-right:20px'></span>
									<!--end::Bullet-->
									<!--begin::Checkbox-->
									{{-- <div class="menuplate form-check form-check-custom form-check-solid mx-5">
										<input class="form-check-input" type="checkbox" value="">
									</div> --}}
									<!--end::Checkbox-->
									<!--begin::Description-->

									<div class="menuplate flex-grow-1 text-gray-800 fw-bolder fs-6" data-id='1'
										id='dplate1' style='font-size:18px;cursor:pointer'>
								...
								@for($i = 2;$i<= $plate;$i++) <div id='addedplate{{ $i }}'
									class="d-flex align-items-center mb-8">
									<span id='active{{$i}}' class="allactive bullet bullet-vertical h-40px bg-danger"
										style='margin-right:20px;display:none'></span>

									<div data-id='{{ $i }}' id='dplate{{ $i }}'
										class='menuplate flex-grow-1 text-gray-800 fw-bolder fs-6'>
										Pack {{ $i }}(<span class='plate_item m-1 cart_qty' data-id='{{ $i }}'
											id='{{ $i }}'>
									...
									<a id='lastplate' data-id={{ $i }} style='cursor: pointer;background:red'
										class="deleteplate btn btn-danger btn-sm fs-8 fw-bolder">Del</a>
									@endif
							</div>
						...
						<div class='float-left m-5'>
							<a href='#' style='float:left;margin:0px 10px 10px 0px'
								class='float-md-left btn btn-secondary btn-sm'>↑
							</a>
						</div>
						<div class='float-left m-5'>
							<a id='empty_cart' onclick='return confirm("Are you sure you want to empty cart?")'
								style='float:left;margin:0px 10px 10px 0px'
								class='float-md-left btn btn-danger btn-sm'>Empty Cart
							</a>
						</div>
						<div class='float-right m-5'>
							<a href='/showcart' id='checkoutdesign'
								style='float:right;margin:0px 10px 10px 0px;background:#ebab21'
								class='checkoutdesign float-md-right btn btn-success'>Checkout
								→</a>
						</div>
	...
	<!--end::Content-->
	<!--begin::Footer-->
	<div class="footer py-4 d-flex flex-lg-column my-auto col-md-12 container gap-7 gap-lg-10"
		style='display:none !important;position:fixed;bottom:0;right:0px;left:0px;height:50px;background:#ebab21;color:white;text-align:center;border-radius:10px'
		id="kt_footer">
		<!--begin::Container-->
		<div class='container'>
			<a href='#subcart' style='font-size:20px;color:white'>
				...
				Cart (
				<span id='maincart' class='text-danger'>
		...
		$(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function($data) {
                    ...
                    Swal.close()
                    Swal.fire('Complaint Submitted!', 'Complaint has been submitted successfully!', 'success')
                ...
                error: function(data) {
                    console.log(data)
                    Swal.close()
                    Swal.fire('Opps!', 'Complaint not submitted, fill the neccessary fields or try again later', 'error')
                }
            })
			...
			$('body').on('click','.deleteplate',function() {
				...
				$.get("{{ route('deleteplate') }}?id="+id,function(data) {
					...
					<a id="lastplate" data-id="${id2}" style="background:red" class="deleteplate btn btn-danger fs-8 fw-bolder">Del</a>
					`)
					// $("#ddel"+id).remove()
			...
			var id = $("#plate").find("span:last").attr('id');
			rid = parseInt(id) + 1;
			$(".deletefood").hide()
			// alert(id)
			if(rid == 16) {
				...
				<div id='addedplate${rid}' class="d-flex align-items-center mb-8">
					...
					<a id="lastplate" data-id="${rid}" style="background:red"
						class="deleteplate btn btn-danger fs-8 fw-bolder">Del</a>
				</div>
				`)
