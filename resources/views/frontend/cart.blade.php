            ...
            <div style='padding-left:0px !important' class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div style='padding-top:10px' class="container-xxl" id="kt_content_container">
                        ...
                        <form method='post' action='{{route("checkout", [$cc*$rest->pack_fee+$rest->ct_charge])}}'
                            ...
                            <div class="d-flex flex-column flex-lg-row-fluid p-8">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="d-flex flex-column gap-5 gap-md-7">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                ...
                                                <tbody class="fw-bold text-gray-600">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type='hidden' id='g_total'
                                                            value='{{$carts->totalPrice + $rest->ct_charge}}' />
                                                        <input type='hidden' name='delivery_amount'
                                                            id='delivery_form' />
                                                        <input type='hidden' id='sstotal'
                                                            value='{{ $carts->totalPrice }}' />
                                                        <input type='hidden' name='ct_charge' id='ct_charge'
                                                            value='{{ $rest->ct_charge }}' />
                                            ...
                                            @if($rest->block == 0)
                                            <div
                                                class="form-check form-check-custom form-check-solid justify-content-end">
                                                <input class="form-check-input" type="checkbox" value=""
                                                    id="order_preference" />
                                                <label class="form-check-label" for="order_preference">Save this order
                                                    combination to your fastpay account.</label>
                                            </div>
                                            <div style='display:none' id='preference_show' class="row">
                                                <div class="col-md-8 offset-md-4">
                                                    <div class="row justify-content-end">
                                                        <div class="col-md-8">
                                                            <label>Name</label>
                                                            <input id='preference_name'
                                                                class="form-control form-control-sm mb-2 "
                                                                placeholder="e.g my low budget breakfast">

                                                            <label>Email address</label>
                                                            <input type='hidden' value='{{ json_encode($carts) }}'
                                                                id='cart_preference' />

                                                            <input id='email_address'
                                                                class="form-control form-control-sm mb-2"
                                                                placeholder="Your fastpay email address">
                                                            <label>Yet to have a fastpay account? click <a
                                                                    href='https://fastpay.com/register'>here</a> to
                                                                create one.</label>
                                                            <button style='background:#ebab21' type='button'
                                                                id='save_preference'
                                ...
                                <!--end::Order details-->
                                @if($rest->block == 0)
                                <div class='text-danger justify-content-end m-4'>Fund your <a
                                        href='https://fastpay.cttaste.com/register' style='color:blueviolet'> fastpay
                                        wallet </a> today, and save yourself the stress of bank transfer everytime!
                                </div>
                                @endif
                                <div class="d-flex justify-content-end m-4">
                                    ...
                                    <!--begin::Button-->
                                    @if($rest->block == 0)
                                    <button type="submit" name='payonline' style='margin-right:4px'
                                        id="kt_ecommerce_edit_order_submit" class="btn btn-secondary">
                                        <span class="indicator-label"> <span
                                                ...
                                                <!--end::Svg Icon-->
                                            </span>Pay with Fastpay</span>
                                        <span class="indicator-progress">Please wait...
                                            <span
                                                class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                    </button>
                                    @endif
                                    <button type="submit" name='checkout' id="kt_ecommerce_edit_order_submit"
                                        style='background:#075E54' class="btn btn-success">
                                        <span class="indicator-label"><i class="fab fa-whatsapp mr-5"></i> Proceed To
                                            Whatsapp</span>
                                        <span class="indicator-progress">Please wait...
                                            <span
                                                class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
