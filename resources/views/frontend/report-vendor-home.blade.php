...
<body id="kt_body" class="header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
	...
	<div style='display:none' id='post_body'>
		<header class="showcase"
			style='background-size: cover;background-color:grey;background-repeat:no-repeat;background-image: url(assets/images/homebanner2.webp)'>
			<div class="container">
				<nav>
					<div>
						<a href="#">
							{{-- <i class="fa fa-mobile-alt"></i> --}}
							<img src="assets/images/logo.png" width="100" height='30' alt='logo' class='lazyload'>
						</a>
					</div>
					<div class="right-menu">
						<a class="bold-place" href="/register">Register/Login<br> as a vendor ➜</a>
						<!--<a href="/register">Sign up</a>-->
					</div>
				</nav>
				<div class="hero-text">
					<h1 class="bold-place;font-family:cursive"><span class="bold-place"
							style='font-family:cursive'>Explore your tastebuds</span></h1>
					...
					<input style='background:#ebab21' type='submit' value='Search'
		...
		<section class="container" style='margin-bottom:5px'>
			...
			@else
			<h2>Available <span style='color:#ebab21'>Restaurants</span> in <span id='realschool'>Funaab</span></h2>
			...
			<div class='row'>
				<div class='col-md-6'>
					<label style='background:#fff3cd;color:#856404;border-left-color:#856404;border-left-width:5px'
						class="btn btn-outline btn-warning-dashed btn-outline-default p-7 d-flex align-items-center mb-2"
						...
						<span class="d-block text-start">
							...
							<span class="fs-6" style='color:#856404'>
								Not in Funaab? Change Institution.
								<br>
								<div class='col-md-4'>
				...
				<div class='col-md-6'>
					<label style='background:#f8d7da;color:#721c24;border-left-color:#721c24;border-left-width:5px'
						...
						<span class="d-block text-start">
							<!--<span class="fw-bolder d-block fs-3" style='color:#721c24'>NOTICE !!!</span>-->
							<span class="fs-6" style='color:#856404'>
								Having issue with a particular vendor regularly?
								<br>
								<div class='col-md-4'>
									
									<a style='background:#721c24;border-color:#721c24' class='btn btn-danger btn-sm' data-toggle="modal" data-target="#reportVendorModal">Report Vendor</a>
									<div class="modal fade" id="reportVendorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
					...
					<div class="hover">
						<a data-name='{{ $rest->name }}' class='closed'>
							...
							<img src='https://cttaste.com/cttaste_files/public/profilePic/{{$rest->image}}'
								...
								style='opacity: 0.3;max-height:150px;max-width:300px;background-color:rgb(255,255,255,0.5)'>
							...
							<img src='{{ asset(' profilePic/normal.webp') }}' class="lazyload" width='300px'
								height='150px'
								style='opacity: 0.5;max-height:150px;max-width:300px;background-color:rgb(255,255,255,0.5)' />
		...
		<section class="footer-bar">
			<div class="container">
				<div class="footer-lang">
					<img class="footer-logo lazyload" src="assets/images/logo.png" width='100' height='30'>
