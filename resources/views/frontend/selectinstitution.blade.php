	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="container-fluid d-flex align-items-stretch justify-content-between">
						...
						<div class="d-flex align-items-center" id="kt_header_wrapper">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_wrapper'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-1 fs-3 lh-1">Welcome to CTSpicy</h1>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
						</div>
									...
									<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-600 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold fs-6 my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
										<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
											<span class="menu-link py-3">
												<span class="menu-title">Register your restaurant today</span>
				...
				<!--end::Header-->
				<!--begin::Search form-->
				<!-- <div class="card rounded-0 bgi-no-repeat bgi-position-x-end bgi-size-cover" style="background-color: black;background-size: auto 100%; background-image: url(assets/media/misc/taieri.svg)"> -->
				<div class="card rounded-0 bgi-size-cover" style="background-size: auto 100%; background-image: url(assets/images/banner3.jpeg)">
					<!--begin::body-->
					<div class="card-body container-xxl pt-10 pb-8">
						<!--begin::Title-->
						<div class="d-flex align-items-center">
							<h1 class="fw-bold me-3 text-white">CTSpicy</h1>
							<!-- <span class="fw-bold text-white opacity-50">No 1 Food Ordering Platform for students</span> -->
						</div>
						<!--end::Title-->
						<!--begin::Wrapper-->
								...
								<div class="rounded d-flex flex-column flex-lg-row align-items-lg-center bg-white p-5 w-xxl-850px h-lg-60px me-lg-10 my-5">
									...
									<div class="row flex-grow-1 mb-5 mb-lg-0">
										...
										<div class="col-lg-4 d-flex align-items-center mb-3 mb-lg-0">
											...
											<!--end::Svg Icon-->
											<!--begin::Input-->
											<input type="text" class="form-control form-control-flush flex-grow-1" name="search" value="" placeholder="Search food" />
											<!--end::Input-->
										</div>
										<!--end::Col-->
										<!--begin::Col-->
										<div class="col-lg-4 d-flex align-items-center mb-5 mb-lg-0">
											...
											<!--end::Svg Icon-->
											<!--begin::Select-->
											<select class="form-select border-0 flex-grow-1" data-control="select2" data-placeholder="Restaurant" data-hide-search="true">
                ...
                <section class="container">
					<h1 style='font-family:lato !important' class="local-title">Available Locations</span></h1>
					<div class="locals-grid">
                        @foreach($schools as $key => $value)
                            
                        @endforeach
                        <a href='/school/FUNAAB'>
						<div class="local-box">
							<p>FUNAAB(10 Rest.)</p>
					...
					<div class="container">
						...
						<div class="footer-last-links">
							<ul>
								...
								<li><a href="#">Blog</a></li>
								<li><a href="cthostel.com">CTHostel</a></li>
						...
						<div class="footer-copyright">
							<p><small>CTSpicy is a tech brand that is focused on providing the best food services for students. We do this by prioritizing the needs of students and increasing the sales of every food vendor across each institution. 2022 © CTSpicy Ltd. All rights reserved.</small></p>
						</div>
					</div>
