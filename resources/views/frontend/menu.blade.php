...
<body id="kt_body" style='background-color:#f8f9fa !important' class="header-tablet-and-mobile-fixed">
	...
	<div id='post_body' style='display:none'>
		<div class="d-flex flex-column flex-root">
			<!--begin::Page-->
			<div style='' class="page d-flex flex-row flex-column-fluid">
				<!--begin::Aside-->
														...
														<div class="carousel-inner">
															<div class="carousel-item active">
																...
																<img class="mixed-widget card-rounded-bottom"
																	src="assets/images/fastpay.jpeg" alt="Third slide"
																	class="card-img-top"
													...
													<div class="row g-0">
														...
														<div
															...
															<marquee direction='left'
																...
																;height='100px'>
																<a href='https://wa.me/2348087976000?text=*Hi,%20%20I%20am%20from%20CT_Taste%20t%20I%20want%20to%20trade%20crypto_______.*'
																	...
																	<a href='https://caretech.netlify.app'
																		...
																		Looking for a reliable web application
																		development company to bring your idea or
																		business to live? Look no further than our team
																		of expert developers! Click here to get in
																		touch.
																		{{-- Manifest Exchange: Your Trusted, Reliable,
																		and Expedient Crypto Vendor. click here to get
																		in touch --}}
																	</a>
															</marquee>
			...
			<h1 style="text-align:center;font-family: 'Ubuntu', sans-serif;" class="vendor-header-title">
				{{$rest->name}} - {!! Str::limit($rest->address, 40)!!} <span>
	...
	<div class="card-body p-8" style='background:#fff;'>
		<div class="d-flex flex-column gap-10">
			...
			<div id='cat_cat' style='padding:0px !important;' class="container testimonial-group">
				<div class="rowlex text-center">
					...
					<a href="#pepe{{$cat->id}}" style='font-size:15px'
						class="collex-xm-4 btn btn-sm btn-light btn-active-light-danger py-2 mb-2">
						{{$cat->name}}
					</a>
					@endforeach
				</div>
			...
			{{-- @if($rest->block == 0)
			<div style='font-size:17px; border-top:2px solid #ffc107' class='alert alert-warning'> Save Big on Data,
			...
			<!--begin::Table-->
			<div class='row'>
				<div class="card pt-4 col-md-8 shadow-lg" style='border:1px dashed black'>
								...
								<span class="svg-icon svg-icon-danger me-5">
									...
									<div id='pepe{{$menu->category_id}}' class="symbol symbol-60px symbol-2by3 me-4">
										...
										<div class="symbol-label"
											style="margin-left:20px;background-image: url('{{ $menu->image }}')">
										</div>
										@else
										<div class="symbol-label"
				...
				<div id='subcart' class="col-md-4 mb-8 ">
					<!--begin::List Widget 3-->
					<div class="card card-xl-stretch bg-light-warning"
						style='border-right:5px double #fff;border-radius:25px;border-bottom:5px solid #fff;border-left:5px double #ebab21;border-top:5px double #ebab21;'>
						<!--begin::Header-->
						<div class="card-header border-0">
							<h6 class="card-title fw-bolder text-dark">YOUR ORDERS
						...
						<div id='plate'>
							...
							<div class="platerow card-body pt-2">
								...
								@for($i = 2;$i<= $plate;$i++) <div id='addedplate{{ $i }}'
									...
									<a id='lastplate' data-id={{ $i }} style='cursor: pointer;color:red'
										class="deleteplate fs-8 fw-bolder">Remove pack</a>
									@endif
							</div>
		...
		$(document).ready(function() {
			...
			$('body').on('click','.deleteplate',function() {
				...
				$.get("{{ route('deleteplate') }}?id="+id,function(data) {
					...
					<a id="lastplate" data-id="${id2}" style="color:red;cursor:pointer" class="deleteplate fs-8 fw-bolder">Remove pack</a>
					`)
					// $("#ddel"+id).remove()
