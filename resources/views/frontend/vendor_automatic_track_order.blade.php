                    ...
                    <div class="col-xl-8 col-lg-10">
                        ...
                        <div class="tracking-id-info text-center">
                            ...
                            <div class="tracking-list">
                                ...
                                @elseif($delivery && $delivery->rejected == 1)
                                <div class='alert alert-danger'>This order has been cancelled by the vendor!</div>
                                @else
                                <ul>
                                    <li>
                                        <div class="tracking-list-icon">
                                    ...
                                    <li @if( time()> strtotime($delivery->request_time) && time() <
                                            strtotime($delivery->pick_up_time) && time() <
                                    ...
                                    <li @if( time()> strtotime($delivery->pick_up_time) && time() <
                                            strtotime($delivery->delivery_time)) class="active" @endif>
                                            <div class="tracking-list-icon">
                                                <i class="flaticon-placeholder"></i>
                                            </div>
                            ...
                            <a id='change_status_{{ $delivery->id }}' data-change='{{ $delivery->id }}'
                                style='margin-right:5px' data-id='{{ $delivery->uuid }}'
                            ...
                            @endif
                            <button data-id='{{ $delivery->uuid ?? 0 }}' class="mark_complete btn btn-success m-2">Mark
                                Complete</button>
                            ...
                            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end text-dark">@if($delivery && time() >
                                            strtotime($delivery->pick_up_time)) {{ $delivery->rider_name }} @else Not
                                            yet assigned @endif
                                        </td>
                                    </tr>
                                    <!--end::Payment method-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end text-dark"><a
                                                href='tel:{{ $delivery->rider_phone ?? "" }}'>@if($delivery && time() >
                                                strtotime($delivery->pick_up_time)) {{ $delivery->rider_phone }} @else
                                                Not yet assigned @endif</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-dark">
                                        ...
                                        <td class="fw-bolder text-end text-dark">@if($delivery) {{ date('h:i A',
                                            strtotime($delivery->request_time)) }} @else 0:00 @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-dark">
                                        ...
                                        <td class="fw-bolder text-end text-dark">@if($delivery && time() >
                                            strtotime($delivery->pick_up_time)) {{ Date('h:i
                                            A',strtotime($delivery->pick_up_time)) }} @else Not yet picked up @endif
                                        </td>
                                    </tr>
                                    <!--end::Date-->
                                </tbody>
