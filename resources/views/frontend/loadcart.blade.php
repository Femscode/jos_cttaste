...
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" class="header-tablet-and-mobile-fixed">
                        ...
                        <div class="menu-item py-3">
                            <a href='#cat_cat'>
                                <span class="menu-link menu-center" title="" data-bs-toggle="tooltip"
                                    ...
                                    <span class="menu-icon me-0">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Design/Join-2.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    ...
                                                    <path
                                                        d="M5,12 L10,6 L18,6 L18,10 L12.1666667,10 L9,13.8 L9,19 L5,19 L5,12 Z"
                                                        fill="#000000"
                        ...
                        <div class="menu-item py-3">
                            <a href='#pepe'>
                                <span class="menu-link menu-center" title="" data-bs-toggle="tooltip"
                                    ...
                                    <span class="menu-icon me-0">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Cooking/Dinner.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div class="menu-item py-3">
                            <a href='/subscribe'>
                                <span class="menu-link menu-center" title="" data-bs-toggle="tooltip"
                                    ...
                                    <span class="menu-icon me-0">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Clipboard-check.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div style='padding-left:0px !important' class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                          ...
                          <div class="d-flex align-items-center d-lg-none ms-n3 me-1" title="Show aside menu">
                            <button onclick='window.history.back()' class="btn btn-warning btn-active-color-primary" >
                                <!--begin::Svg Icon | path: icons/duotune/abstract/abs015.svg-->
                                <a class="svg-icon svg-icon-1">
                                    ←Back
                                </a>
                                <!--end::Svg Icon-->
                            </button>
                            ...
                            <div class="d-flex align-items-stretch" id="kt_header_nav">
                                ...
                                <div class="header-menu align-items-stretch" data-kt-drawer="true"
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-600 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold fs-6 my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <div onclick='window.location.href = "/"' data-kt-menu-placement="bottom-start"
                                            class="menu-item here show menu-lg-down-accordion me-lg-1">
                                            <span class="menu-link py-3">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div style='padding-top:10px' class="container-xxl" id="kt_content_container">
                        <!--begin::Form-->
                        <form method='post' action='{{route("checkout_load_order")}}' class="form d-flex flex-column flex-lg-row">
                          
                            <!--begin::Aside column-->
                            <div class="w-100 flex-lg-row-auto w-lg-300px me-2 mt-12 p-8 ">
                                <!--begin::Order details-->
                                <div class="card card-flush py-4 ">
                                    ...
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h2>Order Details</h2>
                                            <input type='hidden' name='fee' value='{{ $cc*$rest->pack_fee+$rest->ct_charge }}'/>
                                        </div>
                                    </div>
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                    <div class="card-body pt-0">
                                        <div class="d-flex flex-column gap-10">
                                            ...
                                            <div class="fv-row">
                                                ...
                                                <div class="fw-bolder fs-3">#CTS-{{ $order_promo_id }}</div>
                                                <input type='hidden' name='order_id' value='CTS-{{ $order_promo_id }}'/>
                            ...
                            <div class="d-flex flex-column flex-lg-row-fluid p-8">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h2>Order ID: #CTS-{{ $order_promo_id }}</h2>
                                        </div>
                                        <div class='float float-right'>
                                            <a href='https://cttaste.com/{{ $rest->slug }}' class='btn btn-primary btn-sm'>Clear and Reorder</a>
                                            <a onclick='window.history.back()' class='btn btn-secondary btn-sm'>Back</a>
                                        </div>
                                    </div>
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                    <div class="card-body pt-0">
                                        <div class="d-flex flex-column gap-10">
                                            ...
                                            <div class="d-flex align-items-center position-relative mb-n7">
                                                ...
                                                <h4 class='float-right' id='total_price'>Total Price: ₦{{number_format($carts->totalPrice)}}</h4>
                                            </div>
                                            @for($j = 1;$j<=$cc;$j++) <?php $great='pack' .$j; ?>
                                                ...
                                                <div class='table-responsive' id='table{{ $j }}'>
                                                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                        ...
                                                        <tbody class="fw-bold text-gray-600 col-md-6">
                                                            ...
                                                            @if($menu['id'] == 0.1)
                                                            <tr style='opacity:0.5' id='content{{ $menu['id'] }}'>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center"
                                                                        ...
                                                                        <div style='padding:1px !important'
                                                                            class="d-flex align-items-center bg-light-danger rounded">
                                                                        ...
                                                                        <div class="ms-5">
                                                                            <!--begin::Title-->
                                                                            <a
                                                                                class="text-gray-800 text-hover-primary fs-5 fw-bolder">{{$menu["name"]}}</a>
                                                                            <!--end::Title-->
                                                                            <!--begin::Price-->
                                                                ...
                                                                <td>
                                                                    <div class="col-md-4">
                                                                        <div class="btn-group mb-md-0 btn-block">
                                                                            <button disabled data-id='{{$menu["id"]}}'
                                                                                data-good='{{ $j }}'
                                                                                id='deletefood{{$menu["id"]}}'
                                                                                type="button"
                                                                                class="removemenu btn btn-danger btn-sm">-</button>
                                                                            <button disabled 
                                                                                id='product_qty{{$menu["id"]}}{{ $j }}'
                                                                                type="button"
                                                                                class="cfood btn btn-secondary btn-sm">{{$menu["qty"]}}</button>
                                                                            <button disabled data-id='{{$menu["id"]}}'
                                                                                data-good='{{ $j }}' type="button"
                                                            ...
                                                            <tr id='content{{ $menu['id'] }}'>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    {{-- <div class='col-sm-4'>
                                                                        <a data-id='{{$menu["id"]}}'
                                                                            data-good='{{ $j }}'
                                                                            class='removemenu btn btn-sm btn-danger pr-1 pl-1 pt-1 pb-1'>-</a>

                                                                        <span id='product_qty{{$menu["id"]}}{{ $j }}'
                                                                            class='badge badge-secondary'
                                                                            id='product_qty{{$menu["id"]}}'>{{$menu["qty"]}}</span>

                                                                        <a data-id='{{$menu["id"]}}'
                                                                            data-good='{{ $j }}'
                                                                            class='addmenu btn btn-sm btn-success pr-1 pl-1 pt-1 pb-1'>+</a>
                                                                    </div> --}}
                                                                </td>
                                        ...
                                        <div class="d-flex flex-column gap-5 gap-md-7">
                                            ...
                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                <div class="fv-row flex-row-fluid">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input required class="form-control" name="name" placeholder="Enter Name"
                                                        value="" />
                                                    <!--end::Input-->
                                                </div>
                                            ...
                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                <div class="fv-row flex-row-fluid">
                                                    ...
                                                    <select class='form-control' id='location' required name='location'>
                                                        ...
                                                        <option value = "{{ $del->name }}" data-value='@if($promo) 0 @else {{ $del->price }} @endif'>{{ $del->name }} - @if($promo) FREE💃🏽😍 @else ₦{{ number_format($del->price) }}@endif</option>
                                                ...
                                                <div class="flex-row-fluid">
                                                    ...
                                                    <input required class="form-control" name="address"
                                                        placeholder="A proper description of your hostel" />
                                                    <!--end::Input-->
                                                </div>
                                            </div>
                                            <!--end::Input group-->
                                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                ...
                                                <tbody class="fw-bold text-gray-600">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end" id='subtotal'><b>₦
                                                                {{number_format($carts->totalPrice)}}</b></td>
                                                    </tr>
                                                    <!--end::Subtotal-->
                                                    <!--begin::VAT-->
                                                    <tr>
                                                        <td colspan="4" class="text-end"><strong>Delivery</strong></td>
                                                        <td class="text-end">₦<b id='delivery_amount'>0</b></td>
                                                    </tr>
                                                   
                                                     <tr>
                                                        <td colspan="4" class="text-end"><strong>Pack Fee</strong></td>
                                                        <td class="text-end">₦<b id='packtotal'>
                                                            @for($j = 1;$j<=$cc;$j++) 
                                                            @if($j == $cc)
                                                            {{ $j * $rest->pack_fee }}
                                                            @endif
                                                    ...
                                                    <tr>
                                                        <td colspan="4" class="text-end"><strong>Charges</strong></td>
                                                        <td class="text-end"><b>₦{{ $rest->ct_charge }}</b></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-dark fs-3 fw-boldest text-end" id='grandtotal'>
                                                           </td>
                                            ...
                                            {{-- <div class="form-check form-check-custom form-check-solid justify-content-end">
                                                <input  class="form-check-input" type="checkbox" value=""
                                                    id="order_preference" />
                                                <label class="form-check-label" for="order_preference">Save this order combination to your fastpay account.</label>
                                            </div> --}}
                                            {{-- <div style='display:none' id='preference_show' class="row">
                                                <div class="col-md-8 offset-md-4">
                                                    <div class="row justify-content-end">
                                                        <div class="col-md-8">
                                                            <label>Email address</label>
                                                            <input type='hidden' value='{{ json_encode($carts) }}' id='cart_preference'/>
                                                            
                                                            <input id='email_address' class="form-control form-control-sm mb-2" placeholder="Your fastpay email address">
                                                            <label>Name</label>
                                                            <input id='preference_name' class="form-control form-control-sm mb-2 " placeholder="e.g my low budget breakfast">
                                                            <label>Yet to have a fastpay account? click <a href='https://fastpay.com/register'>here</a> to create one.</label>
                                                            <button style='background:#ebab21' type='button' id='save_preference' class='btn btn-warning btn-sm'>Save</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div> --}}
                                ...
                                <div class="d-flex justify-content-end m-4">
                                    ...
                                    <button type="submit" name='payonline' style='margin-right:4px' id="kt_ecommerce_edit_order_submit" class="btn btn-secondary">
                                        ...
                                        </svg><!--end::Svg Icon--></span>Pay with Fastpay</span>
                                        <span class="indicator-progress">Please wait...
                                            <span
                                                class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                    </button>
                                    <button type="submit" name='checkout' id="kt_ecommerce_edit_order_submit" style='background:#075E54' class="btn btn-success">
                                        <span class="indicator-label" ><i class="fab fa-whatsapp mr-5"></i> Proceed To Whatsapp</span>
                                        <span class="indicator-progress">Please wait...
                                            <span
                                                class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                    </button>
                                ...
                                <div class="d-flex justify-content-end m-4">
                                <a href="/cancelcart" id="kt_ecommerce_edit_order_cancel"
                                class="btn btn-light btn btn-danger me-5">Cancel Order</a>
                                </div>
                            </div>
                            <!--end::Main column-->
                        </form>
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container-xxl d-flex flex-column flex-md-row flex-stack">
                        ...
                        <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
                            ...
                            <li class="menu-item">
                                <a href="" target="_blank" class="menu-link px-2">CTDog</a>
                            </li>
                        </ul>
                        <!--end::Menu-->
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.addmenu', function() {
                ...
                var h = $("#packtotal").text()
                    console.log(data);
                    $("#total_price").text("Total Price: ₦" + data.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
                    $("#sstotal").val(data)
                    ...
                    $("#grandtotal").text("Total Price: ₦" + total.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
                ...
                $.ajax({
                    ...
                    success: (response) => {
                        ...
                        if(response == true) {
                            ...
                            icon: 'info',
                            html:
                                'You are yet to create a fastpay account, click ' +
                    ...
                    error: function(data) {
                        console.log(data);
                        Swal.fire('Oops!', 'An error occured, contact the admin', 'error')
                        // Swal.close()
                    }
                });
               }
            ...
            $(".product_qty").on('input', function() {
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        // swal("Success", ' Updated successfully', 'success');
                        console.log(data)
                        $("#total_price").text("Total Price: #" + data);
                        $("#subtotal").text("#" + data);
                        var total = parseInt(data) + 50;
                        $("#grandtotal").text("Total Price: #" + total);
            ...
            @if ($discount == 'true')
    Swal.fire({
  title: 'Congratulations, you just won a free delivery, sponsored by Miller Media.',
  html:
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo4/apps/ecommerce/sales/add-order.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 02:22:56 GMT -->
